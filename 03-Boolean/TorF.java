...
public class TorF {
	...
	public boolean cor7() {
		...
		return tf7;} 	//T
	public boolean cor8() {
		boolean tf8 = (i == j || i < 50); 				
		return tf8;} 	//T
	public boolean cor9() {
		boolean tf9 = (i == j && i < 50); 				
		return tf9;} 	//F
	public boolean cor10() {
		boolean tf10 = (i > j || true_false && j >= 4); 
		return tf10;} 	//F		====> the most left worked first
	public boolean cor11() {
		boolean tf11 = (!(i < 2 && j == 5)); 			
		return tf11;} 	//T
	public boolean cor12() {
		boolean tf12 = (!true_false); 					
		return tf12;} 	//T
